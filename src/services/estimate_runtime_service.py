...
from src.models.estimate_runtime_definitions import (
...
def resolve_estimate_event_name(explicit_event_name: str | None, user_id: str) -> str | None:
...
def build_simple_schedule_lines(due_date: date, steps: list[EstimateStep]) -> list[str]:
    schedule_lines: list[str] = []
